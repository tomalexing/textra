  ...
  render() {
    ...
    <div className="page-layout f f-col">
        ...
        <div className="container f-v-gap-2 f-gap-5 u-mt-10">
            ...
            1 страницы.</p>
            <p><h2 className="u-inline-block h3">Наша миссия</h2> - обеспечить вас и ваш бизнес высококлассным качеством перевода текста не просто в сжатые сроки, а прямо «на сейчас».</p>
